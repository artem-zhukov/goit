...
// button.addEventListener('Start', pause());
//button.addEventListener('Clear', clearСlock());
function startTIME() {
  if (init == 2) return;
 	var cdateObj = new Date();
  fullTime = tempTime + cdateObj.getTime() - dateObj.getTime() - 7200000;
...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=67ee49909cdb8bcb6aae)
 * Config saved to config.json and https://gist.github.com/67ee49909cdb8bcb6aae
 */
